...
//               setTimeout(getCity,2000);
            }
//          function getCity(target){
//            	       var citys_data;
//								   $.ajax({
//								   	type:'get',
//								   	url:"http://api.duwu.mobi/duwu/vto/citylist.json?parentid=39&test=1",
//								   async:false,
//								   success:function(res){
//								   	citys_data = res.attachment;
//								   	 var ref = target.childNodes[val].getAttribute('ref');
//			                             var childData=[];
//			
//			                             var nextData= citys_data;
                ...
                switch (_self.type) {
                    ...
                    case 2:
		                        ...
		                        var provs_data;
								   $.ajax({
								   	type:'get',
								   	url:"http://api.duwu.mobi/duwu/vto/citylist.json?parentid=0&test=1",
								   async:false,
								   success:function(res){
								   	provs_data = res.attachment;
//								   _self.data.push(provs_data); 
								  	 }
								   });
                          	       var citys_data;
								   $.ajax({
									   	type:'get',
									   	url:"http://api.duwu.mobi/duwu/vto/citylist.json?parentid=2&test=1",
									   async:false,
									   success:function(res){
									   	citys_data = res.attachment;
//									   	 _self.data.push(citys_data); 
									   }
								   })
					_self.data=[provs_data,citys_data,citys_data]
